...
def main():
    ...
    print("English:\nPositive: {}\tNegative: {}\tnormalized value: {}\n".format(pos_en, neg_en, (pos_en+neg_en)/4))
    print("Finnish:\nPositive: {}\tNegative: {}\tnormalized value: {}\n".format(pos_fi, neg_fi, (pos_fi+neg_fi)/4))
    print("Danish:\nPositive: {}\tNegative: {}\tnormalized value: {}\n".format(pos_da, neg_da, (pos_da+neg_da)/4))
    print("Norwegian:\nPositive: {}\tNegative: {}\tnormalized value: {}\n".format(pos_no, neg_no, (pos_no+neg_no)/4))
    print("Swedish:\nPositive: {}\tNegative: {}\tnormalized value: {}\n".format(pos_sv, neg_sv, (pos_sv+neg_sv)/4))
